...
export default function BillingToggle({ value, onChange }) {
  return (
    <div className="flex flex-col items-center gap-3">
        ...
        {MODES.map((mode) => {
          ...
          return (
            <button
              ...
              className={`font-mono cursor-pointer px-5 py-2 text-[0.7rem] tracking-[0.22em] uppercase transition-colors duration-300 ${
      ...
      <p className="font-mono text-[0.68rem] tracking-[0.14em] text-ash/70">
        {BILLING[value].note}
      </p>
    </div>
  )
